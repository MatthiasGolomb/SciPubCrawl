#!/usr/bin/env python3
"""CLI wrapper for heuristic entity extraction from Marker-generated Markdown.

Example:
  python scripts/extract_heuristic.py \
    --md-root examples/lithium_metal_anode/convert/crossref_md \
    --out examples/lithium_metal_anode/extract/crossref_md_output

This is intentionally separate from the LLM pipeline in scripts/extract_marker.py.
"""
import argparse
...
MODULE_FILE = SRC_ROOT / "extract_heuristic.py"
...
extract_heuristic_fn = getattr(mod, "extract_heuristic")
...
def main() -> None:
    ...
    extract_heuristic_fn(args.md_root, args.out)
