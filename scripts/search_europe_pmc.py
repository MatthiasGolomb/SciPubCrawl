...
def _load_module() -> object:
    ...
    module_file = src_root / "alchemy_refactor" / "search_europe_pmc.py"
    spec = importlib.util.spec_from_file_location("alchemy_refactor.search_europe_pmc", str(module_file))
