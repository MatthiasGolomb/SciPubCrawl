...
def _load_module() -> object:
    """Load ChemRxiv search utilities from src/."""
    this_dir = Path(__file__).resolve().parent
    src_root = this_dir.parent / "src"
    module_file = src_root / "search_chemrxiv.py"
    spec = importlib.util.spec_from_file_location("search_chemrxiv", str(module_file))
